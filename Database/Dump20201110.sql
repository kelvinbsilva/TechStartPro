CREATE DATABASE  IF NOT EXISTS `olist` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `olist`;
...
CREATE TABLE `procat` (
  ...
  CONSTRAINT `idcategories` FOREIGN KEY (`idcategories`) REFERENCES `categories` (`id`),
...
-- Dump completed on 2020-11-10  0:23:02
